...
const createStudent = async (req: Request) => {
  ...
  // console.log('academicDepartment', academicDepartmentResponse);
  // console.log('academicFaculty', academicFacultyResponse);
  // console.log('academicSemester', academicSemesterResponse);
